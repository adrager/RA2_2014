...
VectorDouble = cms.vstring('firstDoulbe','second::Double(NameSecond)','thriddouble'),
VectorInt = cms.vstring('firstDoulbe','second::Double(NameSecond)','thriddouble'),
VectorBool = cms.vstring('firstDoulbe','second::Double(NameSecond)','thriddouble'),
VectorString = cms.vstring('firstDoulbe','second::Double(NameSecond)','thriddouble'),
VectorTLorentzVector = cms.vstring('firstDoulbe','second::Double(NameSecond)','thriddouble'),
)
